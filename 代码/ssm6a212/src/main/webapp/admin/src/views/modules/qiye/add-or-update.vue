    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="企业简介" prop="qiyejianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qiyejianjie" label="企业简介" prop="qiyejianjie">
                    <span v-html="ruleForm.qiyejianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qiyejianjie = this.ruleForm.qiyejianjie.replace(reg,'../../../ssm6a212/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
