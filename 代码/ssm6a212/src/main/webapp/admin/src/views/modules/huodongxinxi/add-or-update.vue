<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="活动开始时间" prop="huodongkaishishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huodongkaishishijian" label="活动开始时间" prop="huodongkaishishijian">
              <el-input v-model="ruleForm.huodongkaishishijian" 
                placeholder="活动开始时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="活动结束时间" prop="huodongjieshushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huodongjieshushijian" label="活动结束时间" prop="huodongjieshushijian">
              <el-input v-model="ruleForm.huodongjieshushijian" 
                placeholder="活动结束时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg,'../../../ssm6a212/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
