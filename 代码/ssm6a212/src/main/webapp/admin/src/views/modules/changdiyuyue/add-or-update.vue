<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议主体" prop="huiyizhuti">
          <el-input v-model="ruleForm.huiyizhuti" 
              placeholder="会议主体" clearable  :readonly="ro.huiyizhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议主体" prop="huiyizhuti">
              <el-input v-model="ruleForm.huiyizhuti" 
                placeholder="会议主体" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参会人数" prop="canhuirenshu">
          <el-input v-model="ruleForm.canhuirenshu" 
              placeholder="参会人数" clearable  :readonly="ro.canhuirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参会人数" prop="canhuirenshu">
              <el-input v-model="ruleForm.canhuirenshu" 
                placeholder="参会人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地费用" prop="changdifeiyong">
          <el-input v-model="ruleForm.changdifeiyong" 
              placeholder="场地费用" clearable  :readonly="ro.changdifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="场地费用" prop="changdifeiyong">
              <el-input v-model="ruleForm.changdifeiyong" 
                placeholder="场地费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
