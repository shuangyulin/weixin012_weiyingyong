<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报名人员" prop="baomingrenyuan">
          <el-input v-model="ruleForm.baomingrenyuan" 
              placeholder="报名人员" clearable  :readonly="ro.baomingrenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报名人员" prop="baomingrenyuan">
              <el-input v-model="ruleForm.baomingrenyuan" 
                placeholder="报名人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
